...
The enclosure supports pass-through ventilation with air flowing through the enclosure's internal structure.
This allows the use of the enclosure in a stacked assembly (for instance in rack cabinets) or in space-constrained applications.
When installed in a 19" rack cabinet, it is possible to fit up to 8 units in a single row, which uses 2.5U of the vertical space.
The enclosure includes VESA mounting holes and a 1/4" - 20 UNC threaded slot compatible with tripods and other photographic accessories. 

The CNC-milled part files are optimized for compatibility with the popular 3-axis CNC machining process.

You can learn more about the Antmicro Baseboard for NVIDIA Jetson Thor from this [blog article](https://antmicro.com/blog/2026/01/ruggedized-jetson-agx-thor-baseboard-setup).

## Mechanical outline

The mechanical outline along with the overall dimensions is presented in the graphics below.
